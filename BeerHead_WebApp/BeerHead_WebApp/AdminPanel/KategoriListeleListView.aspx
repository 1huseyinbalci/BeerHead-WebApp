<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanel.Master" AutoEventWireup="true" CodeFile="KategoriListeleListView.aspx.cs" Inherits="BeerHead_WebApp.AdminPanel.KategoriListeleListView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <h2 style="margin:20px 0px 0px 250px">Kategori Listesi</h2>
