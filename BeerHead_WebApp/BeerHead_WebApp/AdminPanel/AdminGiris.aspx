<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminGiris.aspx.cs" Inherits="BeerHead_WebApp.AdminPanel.AdminGiris" %>
...
<body>
    <form id="form1" runat="server">
        <img src="assets/SiteImages/pngwing.com.png" class="logo" />
        <div class="panelContainer">
            ...
            <div class="panelContent">
                ...
                <div class="row">
                    <asp:TextBox ID="tb_kullaniciAdi" runat="server" CssClass="inputbox" placeholder="Kullanıcı Adı" Text="admin"></asp:TextBox>
                </div>
                <div class="row">
