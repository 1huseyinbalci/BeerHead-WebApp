<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="MakaleDetay.aspx.cs" Inherits="BeerHead_WebApp.MakaleDetay" %>
    ...
    <div class="yorumpanel">
        ...
        <div class="yorumPanelIcerik">
             <asp:Panel ID="pnl_basarili" runat="server" CssClass="pnl_basarili" Visible="false">
               Yorumunuz başarıyla eklenmiştir.Admin onayından sonra yayınlanacaktır.
            </asp:Panel>
